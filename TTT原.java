...
public class TTT3{
  ...
  /**
  Check if there are three noughts or crosses in a single row, column or diagonal
  @param symbol 'X' or 'O'
  @return true if there are three noughts or crosses in a single row, column or diagonal
  */
