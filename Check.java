...
public class Check{
  ...
  /**
  goCenter() checks if the center cell is empty; if yes, let the computer take that cell
  ...
  */
  ...
  /**
  edge() checks if there are empty cells on the edges (i.e. cell [0][1],[1][0],[1][2],[2][1])
  ...
  */
  public static boolean edge(){
    ...
    return checkEdge(check);
  }

  /**
  checkEdge(check) checks if one of cell0][1], cell[1][0], cell[1][2], cell[2][1] is empty; if yes, the computer occupies that cell
  ...
  */
  ...
  /**
  corner() checks if there is empty cell on the corner
  ...
  */
  ...
  /**
  checkCorner(check) lets the computer takes one corner of the board if the cell
  ...
  */
  ...
  /**
  checkEmpty() finds the empty cells in this 3*3 board and let computer take the first
  empty cell it finds
  */
  ...
  /**
  noughtsOrCross(symbol) checks if there are two noughts or crosses on a single row, column or diagonal
  @param symbol 'X' or 'O'
  ...
  */
  ...
  /**
  row(symbol) checks if there are two noughts or two crosses on a single row
  @param symbol 'X' or 'O'
  ...
  */
  ...
  /**
  checkRow(check,symbol) checks if there are two noughts or two crosses on row 0,1,or 2
  ...
  */
  ...
  /**
  twoOccupied(a,b,c,d,e,f,check,symbol) checks if a row, column, or diagonal has two cells occupied by the same symbol('X' or 'O')
  ...
  */
  ...
  /**
  col(symbol) checks if there are two noughts or two crosses on a single column
  @param symbol 'X' or 'O'
  ...
  */
  ...
  /**
  checkCol(check,symbol) checks if there are two noughts or two crosses on column 0,1,or 2
  @param check initial value is true
  @param symbol 'X' or 'O'
  ...
  */
  ...
  /**
  checkDiagonal(symbol) checks if there are two noughts or two crosses on the diagonal from left to right
  @param symbol 'X' or 'O'
  ...
  */
  ...
  /**
  checkOppositeDiagonal(symbol) checks if there are two noughts or two crosses on the diagonal from right to left
  @param symbol 'X' or 'O'
  ...
  */
  ...
  /**
    empty(row,col) checks whether a certain cell is empty
